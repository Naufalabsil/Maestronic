const wrapper = document.getElementById('cardtlainWrapper');
const next = document.getElementById('nextBtn');
const prev = document.getElementById('prevBtn');
const cards = document.querySelectorAll('.cardtlain');

// Flag supaya animasi cuma jalan sekali
...
function animateDesktopCards() {
  ...
  const cardWidth = 1000 / visibleCards + 20;
...
// ---------- Jalankan sesuai layar ----------
if(window.matchMedia("(max-width: 1100px)").matches){
  animateMobileCards(); // HP
}else{
